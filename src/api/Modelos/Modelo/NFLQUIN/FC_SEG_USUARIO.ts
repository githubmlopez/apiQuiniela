  ...
  const rules: ValidationRule[] = [
    ...
    // 2. APELLIDO_PATERNO: Obligatorio, Máx 50 chars
    {
      ...
      exec: (inst : any, campo, label) => 
        ...
        validators.length(inst.APELLIDO_PATERNO, 1, 10, campo, label)
    },
    ...
    // 3. APELLIDO_MATERNO: Obligatorio, Máx 50 chars
    {
      ...
      exec: (inst : any, campo, label) => 
        ...
        validators.length(inst.APELLIDO_MATERNO, 1, 10, campo, label)
    },
    ...
    // 4. NOMBRE: Obligatorio, Máx 50 chars
    {
      ...
      label: 'Nombre',
        ...
        validators.length(inst.NOMBRE, 1, 10, campo, label)
    },
...
// ============================================
// 🧩 Hook BEFORE CREATE para FC_SEG_USUARIO
// ============================================

FC_SEG_USUARIO.addHook('beforeCreate', async (instance: any) => {
...
// ============================================
// 🧩 Hook BEFORE UPDATE para FC_SEG_USUARIO
// ============================================
